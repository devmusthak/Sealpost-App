            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  if (item.timeLabel.trim().isNotEmpty) const SizedBox(height: 8),
...
class _ChatActionDialog extends StatelessWidget {
  const _ChatActionDialog({
    required this.title,
