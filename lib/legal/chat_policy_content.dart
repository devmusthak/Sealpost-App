...
2. ILLEGAL OR HARMFUL CONTENT
Do not send or store content that is illegal, exploitative, fraudulent, defamatory, or intended to cause harm. This includes phishing, impersonation, malware, and social engineering attempts.

3. PRIVACY AND CONFIDENTIALITY
Only share personal or sensitive information when you have a valid reason and lawful basis. You are responsible for obtaining permission before sharing someone else’s personal data.

4. GROUP CHAT RESPONSIBILITIES
Group creators and admins are responsible for managing group membership and maintaining safe behavior in groups they manage. Abuse of invite links or forced group adds is not allowed.

5. SPAM AND BULK MESSAGING
Do not use chat for unsolicited bulk messages, repetitive promotions, or automated spam behavior. We may throttle, restrict, or suspend accounts that generate abusive messaging patterns.

6. FILES, LINKS, AND MEDIA
